...
function vHelp() {
  return [
    ...
    "  Look:     look (l), examine <X> (x), read <X>, listen, smell, taste, touch",
    "  Search:   search <X>   (find hidden things — bodies, drawers, vanities)",
    "  Items:    take <X>, take all, drop <X>, put <X> in <Y>, inventory (i)",
    "  Use:      use <X>, use <X> on <Y>, light <X>, extinguish <X>",
    "            open/close/push/pull/turn <X>, lock/unlock <X> with <Y>",
    "            break <X> with <Y>, pry <X> with <Y>, cut <X>",
    "            wind/play <X>, show/give <X> to <Y>, place <X>, test <X>",
    "            wear/remove <X>, tie <X> to <Y>",
    "  Talk:     talk to <NPC>, ask <NPC> about <topic>, tell <NPC> about <topic>",
    "            say/name <word>, knock <X>, ring <X>, feed <NPC>",
    "            pray, eavesdrop",
